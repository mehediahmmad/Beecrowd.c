...
sphere being provided the value of its radius (R) . The
formula to calculate the volume is: (4/3) * pi * R3.
...
with a space before and after the equal signal. The value must be
